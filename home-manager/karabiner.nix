...
in
{
  imports = [ inputs.karabinix.homeManagerModules.karabinix ];
        ...
        (mkProfile {
          ...
          complex_modifications = {
            ...
            rules = [
              ...
              (mkRule "BSK V3 PRO G Specific" (
                mkDeviceSpecificRules "BSK V3 PRO G" {
                  product_id = 171;
                  vendor_id = 5426;
                }
              ))
