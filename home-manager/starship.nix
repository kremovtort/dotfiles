{ pkgs, ... }:
{
  ...
  programs.starship = {
    ...
    settings = {
      ...
      cobol.format = "(via [$symbol($version )]($style))";
      crystal.format = "(via [$symbol($version )]($style))";
      daml.format = "(via [$symbol($version )]($style))";
      ...
      fennel.format = "(via [$symbol($version )]($style))";
      gleam.format = "(via [$symbol($version )]($style))";
      ...
      rlang.format = "(via [$symbol($version )]($style))";
      ...
      typst.format = "(via [$symbol($version )]($style))";
      vagrant.format = "(via [$symbol($version )]($style))";
      vlang.format = "(via [$symbol($version )]($style))";
